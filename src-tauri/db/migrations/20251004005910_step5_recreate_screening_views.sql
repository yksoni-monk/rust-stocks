-- Migration Step 5: Recreate essential screening views
-- Risk: LOW (creating views, no data changes)
-- Impact: Restores screening functionality

-- 1. O'Shaughnessy Value Composite View
