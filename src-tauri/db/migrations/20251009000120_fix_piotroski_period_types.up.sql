-- Fix Piotroski views to use correct period_types:
-- income_statements: 'FY' instead of 'TTM'
-- balance_sheets: 'Annual' instead of 'TTM'
-- cash_flow_statements: 'Annual' instead of 'TTM'
...
-- Recreate piotroski_multi_year_data with correct period_types
...
WITH financial_data AS (
    SELECT
        ...
        -- Prior year data (for year-over-year comparisons)
...
SELECT
    ...
    -- Changed from gross_margin to net_margin
    CASE
