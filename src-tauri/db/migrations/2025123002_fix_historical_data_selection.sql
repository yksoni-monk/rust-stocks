-- Migration: Fix historical data selection in Piotroski F-Score
-- Created: 2025-12-30
-- Purpose: Fix missing prior-year data by improving historical data selection logic
-- Problem: View prioritizes balance sheets with current assets/liabilities, skipping prior year
-- Solution: Use separate logic for current vs prior year data selection
