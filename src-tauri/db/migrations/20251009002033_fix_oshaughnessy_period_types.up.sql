-- Fix O'Shaughnessy view to use correct period_type for income_statements
-- income_statements uses 'FY', not 'Annual'
-- balance_sheets and cash_flow_statements use 'Annual'
